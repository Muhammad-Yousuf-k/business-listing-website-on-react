...
export default function AdvertisePage() {
  return (
    <div style={{ backgroundColor: "var(--secondary-color)", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-3xl">
          ...
          <h1 className="exo-2 text-(--white-color) font-bold fade-up fade-up-1" style={{ fontSize: "clamp(2.4rem, 6vw, 4rem)", lineHeight: 1.1 }}>
            Advertise on{" "}
            <span className="text-(--accent-color)">Rank Eats</span>
          </h1>

          <p className="text-base sm:text-lg leading-relaxed max-w-xl fade-up fade-up-2 text-(--gray-color)">
      ...
      <section style={{ backgroundColor: "#fff", borderTop: "1px solid #f0ede8", borderBottom: "1px solid #f0ede8" }}>
        <div className="max-w-6xl mx-auto px-4 py-20 flex flex-col lg:flex-row gap-14 items-center">
          {/* Text */}
          <div className="flex flex-col items-start gap-7 w-full lg:w-1/2">
      ...
      {/* ── PRICING ──────────────────────────────────────────── */}
      <section id="pricing" className="max-w-6xl mx-auto px-4 py-20 flex flex-col gap-12">
        <div className="flex flex-col items-center gap-3 text-center">
          <Pill>Pricing</Pill>
      ...
      {/* ── TESTIMONIALS ─────────────────────────────────────── */}
      <section style={{ borderTop: "1px solid #f0ede8" }}>
