...
const StepCard = ({ step = "", icon, title, desc }) => {
    return (
        <div
            className="flex flex-col gap-4 rounded-2xl p-6 border border-(--border-default) hover:border-(--accent-color)  bg-(--white-color) flex-1 basis-[220px]"
        >
            ...
            <h3 className="text-lg font-bold exo-2 text-(--semi-black-color)">{title}</h3>
            <p className="text-sm leading-relaxed text-(--gray-color)" >{desc}</p>
        </div>
    )
}
